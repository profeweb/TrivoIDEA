...
public class Tria {
    ...
    public Tria(PApplet p5, String title, String message, float x, float y, float w, float h){
        this.title = title;
        ...
        this.b2 = new Button(p5, "Opcio2", x + 2*m + wButton, y + h - buttonH*1.5f, wButton, buttonH);
        this.b3 = new Button(p5, "Opcio3", x + 3*m +2*wButton, y + h - buttonH*1.5f, wButton, buttonH);
    }
