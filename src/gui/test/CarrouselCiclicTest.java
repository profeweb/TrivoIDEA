...
import gui.CarrouselCiclic;
import processing.core.PApplet;

public class CarrouselCiclicTest extends PApplet {
    ...
    public static void main(String[] args) {
        PApplet.main("gui.test.CarrouselCiclicTest", args);
    }
    ...
    public void setup(){
        ...
        c = new CarrouselCiclic(50, 100, 900, 300, 3);
